...
static void dumpBuffer ( const char* pHeader, uint8_t* pBuffer, int nSize ) {
	int nIndex = 0;
	printf ( "%s = " , pHeader);
...
//dumpBuffer("pkt.data", pkt.data, 5);
